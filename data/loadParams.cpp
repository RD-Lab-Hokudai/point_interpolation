...
{
    vector<int> data_nos_0204;
    for (int i = 1100; i <= 1300; i++)
    {
        data_nos_0204.emplace_back(i);
    }

    vector<int> data_nos_3_3;
    for (int i = 100; i <= 300; i++)
    {
        data_nos_3_3.emplace_back(i);
    }
    ...
    params["miyanosawa_3_3_rgb_linear"] = {640, 480, 640, 498, 489, 388, 554, 560, 506, "../../../data/2020_03_03_miyanosawa/", data_nos_3_3, "res_linear_miyanosawa_0303_1100-1300_RGB.csv", "linear", false, true};
    params["miyanosawa_3_3_rgb_mrf"] = {640, 480, 640, 498, 489, 388, 554, 560, 506, "../../../data/2020_03_03_miyanosawa/", data_nos_3_3, "res_mrf_miyanosawa_0303_1100-1300_RGB.csv", "mrf", false, true};
    params["miyanosawa_3_3_rgb_ip-basic"] = {640, 480, 640, 498, 489, 388, 554, 560, 506, "../../../data/2020_03_03_miyanosawa/", data_nos_3_3, "res_ip-basic_miyanosawa_0303_1100-1300_RGB.csv", "ip-basic", false, true};
    params["miyanosawa_3_3_rgb_pwas"] = {640, 480, 640, 498, 489, 388, 554, 560, 506, "../../../data/2020_03_03_miyanosawa/", data_nos_3_3, "res_pwas_miyanosawa_0303_1100-1300_RGB.csv", "pwas", false, true};
    ...
    params["miyanosawa_3_3_rgb_original"] = {640, 480, 640, 498, 489, 388, 554, 560, 506, "../../../data/2020_03_03_miyanosawa/", data_nos_3_3, "res_original_miyanosawa_0303_1100-1300_RGB.csv", "original", false, true};
    ...
    params["miyanosawa_3_3_thermal_linear"] = {938, 606, 938 / 2 * 1.01, 495, 466, 450, 469, 503, 487, "../../../data/2020_03_03_miyanosawa/", data_nos_3_3, "res_linear_miyanosawa_0303_1100-1300_Thermal.csv", "linear", false, false};
    params["miyanosawa_3_3_thermal_mrf"] = {938, 606, 938 / 2 * 1.01, 495, 466, 450, 469, 503, 487, "../../../data/2020_03_03_miyanosawa/", data_nos_3_3, "res_mrf_miyanosawa_0303_1100-1300_Thermal.csv", "mrf", false, false};
    params["miyanosawa_3_3_thermal_pwas"] = {938, 606, 938 / 2 * 1.01, 495, 466, 450, 469, 503, 487, "../../../data/2020_03_03_miyanosawa/", data_nos_3_3, "res_pwas_miyanosawa_0303_1100-1300_Thermal.csv", "pwas", false, false};
    params["miyanosawa_3_3_thermal_original"] = {938, 606, 938 / 2 * 1.01, 495, 466, 450, 469, 503, 487, "../../../data/2020_03_03_miyanosawa/", data_nos_3_3, "res_original_miyanosawa_0303_1100-1300_Thermal.csv", "original", false, false};
    ...
    params["miyanosawa_3_3_thermal_ip-basic"] = {938, 606, 938 / 2 * 1.01, 495, 466, 450, 469, 503, 487, "../../../data/2020_03_03_miyanosawa/", data_nos_3_3, "res_ip-basic_miyanosawa_0303_1100-1300_Thermal.csv", "ip-basic", false, false};

    params["miyanosawa_0204_rgb_linear"] = {640, 480, 640, 506, 483, 495, 568, 551, 510, "../../../data/2020_02_04_miyanosawa/", data_nos_0204, "res_linear_miyanosawa_0204_1100-1300_RGB.csv", "linear", false, true};
    params["miyanosawa_0204_rgb_mrf"] = {640, 480, 640, 506, 483, 495, 568, 551, 510, "../../../data/2020_02_04_miyanosawa/", data_nos_0204, "res_mrf_miyanosawa_0204_1100-1300_RGB.csv", "mrf", false, true};
    params["miyanosawa_0204_rgb_ip-basic"] = {640, 480, 640, 506, 483, 495, 568, 551, 510, "../../../data/2020_02_04_miyanosawa/", data_nos_0204, "res_ip-basic_miyanosawa_0204_1100-1300_RGB.csv", "ip-basic", false, true};
    params["miyanosawa_0204_rgb_pwas"] = {640, 480, 640, 506, 483, 495, 568, 551, 510, "../../../data/2020_02_04_miyanosawa/", data_nos_0204, "res_pwas_miyanosawa_0204_1100-1300_RGB.csv", "pwas", false, true};
    params["miyanosawa_0204_rgb_original"] = {640, 480, 640, 506, 483, 495, 568, 551, 510, "../../../data/2020_02_04_miyanosawa/", data_nos_0204, "res_original_miyanosawa_0204_1100-1300_RGB.csv", "original", false, true};

    params["miyanosawa_0204_thermal_linear"] = {938, 606, 938 / 2 * 1.01, 495, 475, 458, 488, 568, 500, "../../../data/2020_02_04_miyanosawa/", data_nos_0204, "res_linear_miyanosawa_0204_1100-1300_Thermal.csv", "linear", false, false};
    params["miyanosawa_0204_thermal_mrf"] = {938, 606, 938 / 2 * 1.01, 495, 475, 458, 488, 568, 500, "../../../data/2020_02_04_miyanosawa/", data_nos_0204, "res_mrf_miyanosawa_0204_1100-1300_Thermal.csv", "mrf", false, false};
    params["miyanosawa_0204_thermal_pwas"] = {938, 606, 938 / 2 * 1.01, 495, 475, 458, 488, 568, 500, "../../../data/2020_02_04_miyanosawa/", data_nos_0204, "res_pwas_miyanosawa_0204_1100-1300_Thermal.csv", "pwas", false, false};
    params["miyanosawa_0204_thermal_original"] = {938, 606, 938 / 2 * 1.01, 495, 475, 458, 488, 568, 500, "../../../data/2020_02_04_miyanosawa/", data_nos_0204, "res_original_miyanosawa_0204_1100-1300_Thermal.csv", "original", false, false};
    ...
    params["13jo_0219_rgb_ip-basic"] = {672, 376, 672 / 2, 504, 474, 493, 457, 489, 512, "../../../data/2020_02_19_13jo/", data_nos_13jo, "res_ip-basic_13jo_0219_10-209_RGB.csv", "ip-basic", false, true};
