...
EnvParams loadParams(string params_name)
{
    ...
    params["miyanosawa_3_3_rgb_original_champ"] = {640, 480, 640, 498, 489, 388, 554, 560, 506, "../../../data/2020_03_03_miyanosawa/", {100, 102, 104, 106, 108}, "res_original_miyanosawa_0303_1100-1300_RGB.csv", "original", false, true};
